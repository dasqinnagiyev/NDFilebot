...
async def ReplyForward(message: Message, file_id: int):
    try:
        await message.reply_text(
            f"**Bu faylın paylaşım linki:**\n"
            f"https://t.me/{Config.BOT_USERNAME}?start=dasqin_{str_to_b64(str(file_id))}\n\n"
            f"__Saxlanılan faylı əldə etmək üçün sadəcə linki açın!__",
